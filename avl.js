...
class Tree {
    ...
    balance(node) {
        ...
        //RL //the height of a node’s right child becomes greater than that of the left child
        if (node.getBalanceFactor() === 2 ) {
         ...
         //LR // the height of a node’s left child becomes greater than that of the right child
        if (node.getBalanceFactor() === -2) {
